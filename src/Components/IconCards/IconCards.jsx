  ...
  const iconCards = [
    {
      ...
      title: "Reliability",
      paragraph:
        "Booked gas slots being available when they arrive. Our system is designed to minimize overbooking and guarantee.",
    },
    {
    ...
    },
    {
      ...
      paragraph:
        "real-time updates on gas station availability, wait times, and booking confirmations. This ensures users have the most accurate information.",
    },
    {
      icon: "fa-solid fa-shield text-primary px-2",
      title: "Safety and Hygiene",
      paragraph:
        "This ensures a clean and secure environment for users.",
    },
    {
      icon: "fa-solid fa-globe text-primary px-2",
      title: "Wide Network",
      paragraph:
        "users can find and book slots at convenient locations.",
    },
    {
      icon: "fa-solid fa-indian-rupee-sign text-primary px-2",
      title: "Transparent Pricing",
      paragraph:
        " Users can trust that the price they see is the price they pay.",
    },
  ];
